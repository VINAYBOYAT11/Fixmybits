"""
Django settings for fixmybits project.
"""
import os
import logging
...
WSGI_APPLICATION = "fixmybits.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "FixMyBits API",
    "DESCRIPTION": "Non-profit cybersecurity marketplace API.",
    "VERSION": "1.0.0",
...
# ──────────────────────────────────────────────────────────────────────────────
# Sentry (disabled when SENTRY_DSN is not set)
# ──────────────────────────────────────────────────────────────────────────────
